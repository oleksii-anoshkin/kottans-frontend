...
> <details>
>   <summary>Linux tutorial end</summary>
...
### Міркування щодо основного матеріалу (Service Worker):

Після вивчення матеріалу про Service Worker ці два слова асоціюються у мене з словосполученнями "керування кешем" та "офлайн-функціонал". На жаль, в мене не вдалося потренуватися та виконати практичне завдання з відео курсу на Udacity (не зміг запустити сервер), але хочу використати Service Worker при виконанні наступного завдання - Pair Game. Загалом, дуже потужний інструмент що розширює можливості використання сайтів за відсутності мережі.

### Міркування щодо додаткового матеріалу (HTTP/2):

Протокол HTTP/2 в порівнянні з HTTP/1.2 безумовно має набагато більше переваг, що пояснює його бажане використання. Я ознайомився з інформацією по протоколу HTTP/2, його перевагами, особливостями та маю надію, що в майбутньому стикнуся з ним та «помацаю» власноруч. На сьогодні, це корисна інформація для кращого, більш широкого розуміння, як все працює.

### Міркування щодо додаткового матеріалу (Computers and the Internet):

Дуже сподобався розділ про протоколи мережі, а саме TCP/IP, DNS, HTTP. Раніше вже вивчав інформацію про них, але тут все подано стисло і гарно. Знайшов багато відповідей на питання, яких не розумів. Також була корисною інформація про розриви. Терміни географічного, соціально-економічного та цифрового розривів були для мене новими та заставили замислитись о речах, про які я раніше не думав.

### Скріншоти виконаних завдань:

> <details>
>   <summary>udacity-offline-web-applications-end</summary>
> <img src="./task_offline_web_app/offline-web-applications-end.png">
> </details>

> <details>
>   <summary>khanacademy-сomputers-and-the-шnternet-end</summary>
> <img src="./task_offline_web_app/сomputers-and-шnternet-end.png">
> </details>
